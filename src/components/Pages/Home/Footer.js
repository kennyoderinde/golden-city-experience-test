...
const Footer = () => {
  return (
    <>
      <div className='flex justify-center -ml-[27rem]'>
        <div className='flex space-x-48 mb-7'>
    ...
    <div className=' w-9/12 border-b border-gray-500 mb-10 flex justify-center'></div>
    </div>
