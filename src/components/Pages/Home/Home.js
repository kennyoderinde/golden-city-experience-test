...
// range slider state
  ...
  return (
    <>
    <div className='mt-24'>
      <div className='w-[1680px] h-full border border-red-400'>
...
{/* note */}
        <div className=' z-0 absolute left-20 w-[984px] h-[171px] bg-white shadow-md rounded-2xl flex flex-row ' style={{ boxShadow: '0 0 20px rgba(0, 0, 0, 0.2)' }}>
